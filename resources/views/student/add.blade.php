        ...
        <div class="white_card_body" bis_skin_checked="1">
            ...
            <form action="{{ route('student.store') }}" method="post">
                ...
                <div class="row" bis_skin_checked="1">
                    ...
                    <div class="col-lg-6" bis_skin_checked="1">
                        <div class="common_input mb_15" bis_skin_checked="1">
                            <input value="{{ old('number') }}" type="text" name="number" placeholder="number">
                            @error('number')
                            <div class="text-danger font-weight-bold">*{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-lg-6" bis_skin_checked="1">
                        <div class="common_input mb_15" bis_skin_checked="1">
                            <input value="{{ old('NationalID') }}" type="text" name="NationalID" placeholder="NationalID">
                            @error('NationalID')
                            <div class="text-danger font-weight-bold">*{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-lg-6" bis_skin_checked="1">
                        <div class="common_input mb_15" bis_skin_checked="1">
                            <input value="{{ old('PersonalCode') }}" type="text" name="PersonalCode" placeholder="PersonalCode">
                            @error('PersonalCode')
                            <div class="text-danger font-weight-bold">*{{ $message }}</div>
                            @enderror
                        </div>
