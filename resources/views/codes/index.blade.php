                    ...
                    <table class="table  dataTable no-footer dtr-inline" id="DataTables_Table_0" role="grid"
                        ...
                        <thead>
                            <tr role="row">
                                ...
                                <th scope="col" class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                    ...
                                    aria-label="User: activate to sort column ascending">code</th>
                                <th scope="col" class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                    rowspan="1" colspan="1" style="width: 64px;"
                                    aria-label="Role: activate to sort column ascending">status</th>
                                <th scope="col" class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                    rowspan="1" colspan="1" style="width: 64px;"
                                    aria-label="Role: activate to sort column ascending">Admin</th>
                                <th scope="col" class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                    rowspan="1" colspan="1" style="width: 74px;"
                                    aria-label="User: activate to sort column ascending">Student</th>
                                <th scope="col" class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                    rowspan="1" colspan="1" style="width: 112px;"
                                    aria-label="Status: activate to sort column ascending">lesson name</th>
                                <th scope="col" class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                    rowspan="1" colspan="1" style="width: 112px;"
                                    aria-label="Status: activate to sort column ascending">Created_at</th>
                                <th scope="col" class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                    rowspan="1" colspan="1" style="width: 64px;"
                                    aria-label="Role: activate to sort column ascending">Updated_at</th>
                                <th scope="col" class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                        ...
                        <tbody>
                            ...
                            <tr role="row" class="odd">
                                ...
                                <td>{{ $code->code }}</td>
                                <td><span
                                    class="{{ $code->status == 1 ? 'status_btn' : 'status_btn yellow_btn' }}">{{ $code->status == 1 ? 'used' : 'not used' }}</span>
                                </td>
                                <td>{{ $code->admins->name }}</td>
                                <td>{{ $code->students->name }}</td>
                                <td>{{ $code->lesson->title }}</td>
