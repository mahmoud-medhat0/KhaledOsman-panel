...
<div class="col-12" bis_skin_checked="1">
    <div class="white_card card_height_100 mb_30" bis_skin_checked="1">
        ...
        <div class="white_card_body" bis_skin_checked="1">
            <form action="{{ route('lesson.store') }}" method="post" enctype="multipart/form-data" id="fileUploadForm">
                @csrf
                <div class="row" bis_skin_checked="1">
                    <div class="col-lg-6">
                        <div class=" mb-0">
                            <label for="title">title</label>
                            <input class="form-control" type="text" name="title" id="videoTitle">
                            @error('title')
                    ...
                    <div class="col-12" bis_skin_checked="1">
                        <center>
                            <div class="create_report_btn mt_30" bis_skin_checked="1">
                                <button type="submit" class="btn_1 radius_btn d-block text-center" > Upload </button>
                            </div>
                        </center>
                    </div>
                </div>
